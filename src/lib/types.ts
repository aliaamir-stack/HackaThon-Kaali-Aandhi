...
// ══════════════════════════════════════════════════════════════════════════════
// APP SESSION / LEGACY VISUALIZATION (extends canonical API response)
// ══════════════════════════════════════════════════════════════════════════════

/** One agent stage for replay UI (start/end in ISO 8601). */
...
/**
 * Full payload stored after analysis: canonical `PipelineResponse` plus
 * optional `pipeline` replay steps and UI escalation hint.
 */
export type AnalyzeSuccessResponse = PipelineResponse & {
  pipeline: PipelineAgentStep[];
  /** Optional; when unset, UI may derive from `is_urgent` && `override_required`. */
  urgentEscalation?: boolean;
};

export type InputMode = "audio" | "image";
